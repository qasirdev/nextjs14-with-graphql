...
export const Novel = ({ novel }: Props) => {
	...
	return (
		<article className="flex flex-col p-4 bg-slate-200 dark:bg-zinc-800 hover:scale-110 shadow-sm hover:shadow-lg hover:bg-slate-300 transition duration-300 ease-out text-black ">
			{/* image */}
			{novel.image && (
				<div>
					<img
			...
			{/*title  */}
			<h1 className="font-bold text-xl my-2">This is: {novel.title}</h1>
			{/* description */}
